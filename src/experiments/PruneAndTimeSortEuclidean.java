 ...
 *
 * Pruning Power and Classification Time sorted with Euclidean Distance
 ...
 */
public class PruneAndTimeSortEuclidean extends Experiments {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Heap:      %20d", heapSize));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Max Heap:  %20d", heapMaxSize));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Free Heap: %20d", heapFreeSize));
        ...
        System.out.println("[PRUNED-TIME-SORTED-EUCLIDEAN] Input Arguments:");
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Project Path:   %s", projectPath));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Dataset Path:   %s", datasetPath));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Problem:        %s", problem));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Runs:           %d", nbRuns));
        if (r >= 0)
            System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] r:              %.2f", r));
        else
            System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] window:         %d", window));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Estimate:       %B", estimate));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Lower Bound:    %s", lowerBound));
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Param:          %d", enhancedParam));
        System.out.println("");
    ...
    private static void singleProblem(String problem, boolean estimate) {
        System.out.println("[PRUNED-TIME-SORTED-EUCLIDEAN] Loading " + problem);
        ...
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] %s loaded", problem));
        ...
        DTW1NN classifier;
        System.out.println(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Creating %s classifier", lowerBound));
        switch (lowerBound) {
            case "LbKim":
        ...
        String filename;
        setResDir("out_sdm/sort_euclidean/" + problem + "/");
        ...
        for (int run = 0; run < nbRuns; run++) {
            ...
            System.out.print(String.format("[PRUNED-TIME-SORTED-EUCLIDEAN] Run %d, Window size %d (%.2f)", run, window, r));
