 ...
 *
 * Pruning Power and Classification Time sorted with LbKeogh
 * java -Xmx14g -Xms14g -cp $LIBDIR: experiments.PruneAndTimeSortLbKeogh $PROJECTDIR $DATASETDIR $PROBLEM $RUNS $WIN $TOESTIMATEORNOT $LOWERBOUND $ENHANCEDPARAM
 * @author Chang Wei Tan, Francois Petitjean, Geoff Webb
 */
public class PruneAndTimeSortLbKeogh extends Experiments {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Heap:      %20d", heapSize));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Max Heap:  %20d", heapMaxSize));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Free Heap: %20d", heapFreeSize));
        ...
        System.out.println("[PRUNED-TIME-SORTED-LBKEOGH] Input Arguments:");
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Project Path:   %s", projectPath));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Dataset Path:   %s", datasetPath));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Problem:        %s", problem));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Runs:           %d", nbRuns));
        if (r >= 0)
            System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] r:              %.2f", r));
        else
            System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] window:         %d", window));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Estimate:       %B", estimate));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Lower Bound:    %s", lowerBound));
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Param:          %d", enhancedParam));
        System.out.println("");
    ...
    private static void singleProblem(String problem, boolean estimate) {
        System.out.println("[PRUNED-TIME-SORTED-LBKEOGH] Loading " + problem);
        ...
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] %s loaded", problem));
        ...
        DTW1NN classifier;
        System.out.println(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Creating %s classifier", lowerBound));
        switch (lowerBound) {
            case "LbKim":
        ...
        String filename;
        setResDir("out_sdm/sort_lbkeogh/" + problem + "/");
        ...
        for (int run = 0; run < nbRuns; run++) {
            ...
            System.out.print(String.format("[PRUNED-TIME-SORTED-LBKEOGH] Run %d, Window size %d (%.2f)", run, window, r));
