...
for problem in "${SMALL[@]}"; do 
	for i in {1..5}; do
            for win in ${WINDOWS[@]}; do
                  java -Xmx14g -Xms14g -cp $PROJECTDIR/lib/*: experiments.Tightness $PROJECTDIR $DATASETDIR $problem $win LbEnhanced $i
            done
            for r in ${RS[@]}; do
                  java -Xmx14g -Xms14g -cp $PROJECTDIR/lib/*: experiments.Tightness $PROJECTDIR $DATASETDIR $problem $r LbEnhanced $i
            done
      done
      for method in ${METHODS[@]}; do 
            for win in ${WINDOWS[@]}; do
                  java -Xmx14g -Xms14g -cp $PROJECTDIR/lib/*: experiments.Tightness $PROJECTDIR $DATASETDIR $problem $win $method 4
            done
            for r in ${RS[@]}; do
                  java -Xmx14g -Xms14g -cp $PROJECTDIR/lib/*: experiments.Tightness $PROJECTDIR $DATASETDIR $problem $r $method 4
            done
      done
done
...
for problem in "${LARGE[@]}"; do 
      ...
      for method in ${METHODS[@]}; do 
            for win in ${WINDOWS[@]}; do
                  java -Xmx14g -Xms14g -cp $PROJECTDIR/lib/*: experiments.Tightness $PROJECTDIR $DATASETDIR $problem $win $method 5
            done
            for r in ${RS[@]}; do
                  java -Xmx14g -Xms14g -cp $PROJECTDIR/lib/*: experiments.Tightness $PROJECTDIR $DATASETDIR $problem $r $method 5
            done
      done
done
